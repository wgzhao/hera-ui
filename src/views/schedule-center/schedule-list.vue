      ...
      <el-main>
        <el-form :model="form" label-width="auto" v-if="form.id">
            ...
            <el-col :span="8">
              <el-form-item label="调度类型:">
                <el-input
                  ...
                  :formatter="value => scheduleTypeOptions[value]"
                ></el-input> </el-form-item
            ></el-col>
            <el-col :span="8">
              <el-form-item label="所有人:">
                <el-input v-model="form.owner"></el-input> </el-form-item
            ></el-col>
          </el-row>
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="关注人员:">
                <el-input v-model="form.focusUser"></el-input> </el-form-item
            ></el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="任务类型:">
                <el-input v-model="form.runType"></el-input> </el-form-item
            ></el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="管理员:">
                <el-input v-model="form.uidS"></el-input> </el-form-item
            ></el-col>
          </el-row>
          ...
          <el-row>
            ...
            ></el-col>
            <el-col :span="8"
              ><el-form-item label="重试次数:" v-if="form.schduleType == 0">
                <el-input
                  v-model="form.configs['roll.back.times']"
                ></el-input> </el-form-item
            ></el-col>
            <el-col :span="8">
              <el-form-item label="重复执行:">
                <el-switch v-model="form.repeatRun"></el-switch> </el-form-item
            ></el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="任务优先级:">
                <el-input
                  v-model="form.configs['run.priority.level']"
                ></el-input> </el-form-item
            ></el-col>
            <el-col :span="8">
              <el-form-item label="重试间隔:">
                <el-input
                  v-model="form.configs['roll.back.wait.time']"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
