    ...
    <el-container>
      ...
      <el-main>
        <el-form :model="form" label-width="auto">
          <el-row>
            <el-col :span="8"> <el-form-item label="任务id:">
                <el-input v-model="form.id"></el-input>
              </el-form-item></el-col>
            <el-col :span="8"> <el-form-item label="调度类型:">
                <el-input v-model="form.scheduleType" :formatter="(value) => scheduleTypeOptions[value]"></el-input>
              </el-form-item></el-col>
            <el-col :span="8"> <el-form-item label="所有人:">
                <el-input v-model="form.owner"></el-input>
              </el-form-item></el-col>
          </el-row>

          <el-row>
            <el-col :span="8"> <el-form-item label="名称:">
            ...
            <el-col :span="8"> <el-form-item label="关注人员:">
                <el-input v-model="form.focusUser"></el-input>
              </el-form-item></el-col>
          </el-row>

          <el-row>
            <el-col :span="8"> <el-form-item label="任务类型:">
                <el-input v-model="form.runType"></el-input>
              </el-form-item></el-col>
            <el-col :span="8">
              ...
              <el-form-item label="重试次数:" v-else>
                <el-input v-model="form.repeatRun"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8"> <el-form-item label="管理员:">
                <el-input v-model="form.uidS"></el-input>
              </el-form-item></el-col>
          </el-row>

          <el-row>
            <el-col :span="8"> <el-form-item label="自动调度:">
                <el-switch v-model="form.auto" active-value="开启" inactive-value="1"></el-switch>
              </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="重试间隔:">
                <el-input v-model="form.rollBackTimes"></el-input>
              </el-form-item></el-col>
            <el-col :span="8"> <el-form-item label="重复执行:">
                <el-switch v-model="form.repeatRun"></el-switch>
              </el-form-item></el-col>
          </el-row>

          <el-row>
            <el-col :span="8"> <el-form-item label="任务优先级:">
                <el-input v-model="form.runPriorityLevel"></el-input>
              </el-form-item></el-col>
            <el-col :span="8"> <el-form-item label="重试间隔:">
                <el-input v-model="form.rollBackWaitTime"></el-input>
              </el-form-item> </el-col>
            <el-col :span="8"> <el-form-item label="机器组:">
                <el-input v-model="form.hostGroupName"></el-input>
              </el-form-item></el-col>
          </el-row>
          ...
          <el-row>
            ...
            <el-col :span="8"> <el-form-item label="预计时长:">
                <!-- <el-input v-model="form.estimatedTime"></el-input> -->
              </el-form-item></el-col>
            <el-col :span="8"> <el-form-item label="区域:">
...
const scheduleTypeOptions = ["自动调度", "定时调度"]
...
const extensions = [sql(), isDark.value ? oneDark : 'default'];
